...
- Scope: `youtube_long_form`
- Population: youtube_long_form integrations with populated `enrichment_offer_type`.
- N: 1
- Outcome: `has_contacts`
...
| Category | With Outcome | Without Outcome | Total | Outcome Rate | Evidence |
|---|---|---|---|---|---|
| Other | 1 | 0 | 1 | 100.0% | Hypothesis |

Stat details:
- Other: Exploratory only: need at least 8 records per group.

### C3: Offer Type and Contacts

- Scope: `short_form`
- Population: short_form rows with populated `enrichment_offer_type`.
- N: 0
- Outcome: `has_contacts`
- Method: Descriptive only; no populated rows.
- Evidence: Hypothesis
- Caveat: No rows contain `enrichment_offer_type` values.
...
- Population: cross_platform_comparable integrations with populated `enrichment_offer_type`.
- N: 1
- Outcome: `has_contacts`
- Method: Counts by category plus Fisher exact category-vs-rest when the sample is large enough.
- Evidence: Hypothesis
...
- Scope: `youtube_long_form`
- Population: youtube_long_form integrations with populated `enrichment_overall_tone`.
- N: 1
- Outcome: `has_contacts`
- Method: Counts by category plus Fisher exact category-vs-rest when the sample is large enough.
- Evidence: Hypothesis
...
- Scope: `short_form`
- Population: short_form rows with populated `enrichment_overall_tone`.
- N: 0
- Outcome: `has_contacts`
- Method: Descriptive only; no populated rows.
- Evidence: Hypothesis
- Caveat: No rows contain `enrichment_overall_tone` values.
...
- Scope: `cross_platform_comparable`
- Population: cross_platform_comparable integrations with populated `enrichment_overall_tone`.
- N: 1
- Outcome: `has_contacts`
- Method: Counts by category plus Fisher exact category-vs-rest when the sample is large enough.
- Evidence: Hypothesis
...
- Scope: `cross_platform_comparable`
- Population: cross_platform_comparable integrations with populated `enrichment_has_personal_story`.
- N: 1
- Outcome: `has_contacts`
- Method: Counts by category plus Fisher exact category-vs-rest when the sample is large enough.
- Evidence: Hypothesis
...
| Category | With Outcome | Without Outcome | Total | Outcome Rate | Evidence |
|---|---|---|---|---|---|
| Yes | 1 | 0 | 1 | 100.0% | Hypothesis |

Stat details:
- Yes: Exploratory only: need at least 8 records per group.

### C9: Integration Position and Contacts

- Scope: `youtube_long_form`
- Population: youtube_long_form integrations with populated `enrichment_integration_position`.
- N: 1
- Outcome: `has_contacts`
- Method: Counts by category plus Fisher exact category-vs-rest when the sample is large enough.
- Evidence: Hypothesis
...
| Category | With Outcome | Without Outcome | Total | Outcome Rate | Evidence |
|---|---|---|---|---|---|
| middle | 1 | 0 | 1 | 100.0% | Hypothesis |

Stat details:
- middle: Exploratory only: need at least 8 records per group.
...
| Contacts -> Deals | 20.0% | 20.0% | 1/1 |
| Deals -> Calls | 50.0% | 50.0% | 1/1 |
| Calls -> Purchase | 100.0% | 100.0% | 1/1 |
